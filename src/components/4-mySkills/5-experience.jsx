        ...
        <div className="vertical-timeline vertical-timeline--animate vertical-timeline--two-columns">
            <div className="vertical-timeline-element">
                ...
                <div className="vertical-timeline-element-content bounce-in">
                    ...
                    <h3 className="font-semibold capitalize">Passed High School</h3>
                    <p className="font-normal mt-0">Sitapur, IN</p>
                    <p className="mt-1 font-normal text-gray-700 dark:text-white/75">
                        Completed my high school curriculum, gaining a solid foundation in
                        various subjects and essential skills.
                    </p>
                    <span className="vertical-timeline-element-date">2021</span>
                </div>
            </div>
            <div className="vertical-timeline-element">
                <span className="vertical-timeline-element-icon bounce-in">
                ...
                <div className="vertical-timeline-element-content bounce-in">
                    <div className="vertical-timeline-element-content-arrow"></div>
                    <h3 className="font-semibold capitalize">React.js Bootcamp</h3>
                    <p className="font-normal mt-0">Lucknow, IN</p>
                    <p className="mt-1 font-normal text-gray-700 dark:text-white/75">
                        Successfully completed an intensive 1-month React.js Developer
                        Bootcamp. Acquired expertise in React components, state management
                        with Redux, and interacting with RESTful APIs.
                    </p>
                    <span className="vertical-timeline-element-date">2022</span>
                </div>
            </div>
            <div className="vertical-timeline-element">
                <span className="vertical-timeline-element-icon bounce-in">
            ...
            <span class="vertical-timeline-element-date">2022</span>
          </div>
        </div>
        <div id="" class="vertical-timeline-element">
          <span
            style="background:#fff;font-size:1.5rem"
          ...
          >
            ...
            <h3 class="font-semibold capitalize">
              Freelancer React.js Developer
            </h3>
            <p class="font-normal !mt-0">Bangalore, IN</p>
            <p class="!mt-1 !font-normal text-gray-700 dark:text-white/75">
              Working as a freelance React.js Developer, I have collaborated
              with various clients to create responsive and dynamic web
              applications.
            </p>
            <span class="vertical-timeline-element-date">2022 - present</span>
          </div>
        </div>
      </div>
    </>
